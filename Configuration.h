...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT 5    // Y point for Z homing when homing all axis (G28).
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {81.16, 79.65, 1538.5, 96.0}  // default steps per unit for Ultimaker
